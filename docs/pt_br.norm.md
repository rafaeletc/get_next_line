...
-   Usar uma variável global que não está marcada como const ou static é
    proibido e considerado um erro de norma, a menos que seja
    explicitamente permitido no projeto.
